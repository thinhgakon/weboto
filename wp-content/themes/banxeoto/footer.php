		...
		<div class="footer-bg">
				...
				<div class="container">
					<div class="row">
						<div class="col-lg-3 col-md-6 col-sm-6 col-12 item">
							...
							<ul class="lh2-ul">
								<li><i class="fas fa-map-marker-alt"></i> K7, P Bến Thuỷ, Vinh, Nghệ An</li>
								<li><i class="fas fa-phone"></i> 0915.1234.37</li>
								<li><i class="fas fa-envelope"></i> Email: dichvucntt37@gmail.com</li>
							</ul>
						</div>
						<div class="col-lg-3 col-md-6 col-sm-6 col-12 item">
			...
			<div class="block-copyright">
				<div class="container">
					<p>Copyright © 2020 Vinh Group. All Right Reserved.</p>
				</div>
			</div>
		</div>
	...
	<?php wp_footer(); ?>
	<div id="fb-root"></div>
	<script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v7.0" nonce="RRdC7zAX"></script>
</body>
</html>