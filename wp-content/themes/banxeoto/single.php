			...
			<div class="row">
				<div class="col-lg-9">
					<div class="border">
						...
						<?php the_content(); ?>
						<p class="author">Tác giả: <?php the_author(); ?></p>
						    ...
						    if ($categories) 
						    {
						        ...
						        if( $my_query->have_posts() ) 
						        {
						            ...
						            while ($my_query->have_posts())
						            {
						                $my_query->the_post();
						                ?>
						                <li><a href="<?php the_permalink(); ?>"><span><i class="fa fa-angle-double-right" aria-hidden="true"></i></span><?php the_title(); ?> ( <i> <?php echo get_the_date(); ?></i> ) </a> </li>
						                <?php
						            }
						            echo '</ul>';
						        }
